...
function Form() {
  ...
  return /*#__PURE__*/(
    React.createElement("div", { className: "bg-white p-6 rounded-2xl w-max" }, /*#__PURE__*/
    ...
    " ", /*#__PURE__*/
    React.createElement("div", { className: "h-2 w-full rounded-lg mt-8" }, "\u0644\u0637\u0641\u0627 \u0634\u0645\u0627\u0631\u0647 \u062A\u0644\u0641\u0646 \u0648\u0627\u0631\u062F \u06A9\u0646\u06CC\u062F."),
    ...
    React.createElement("div", { className: "h-4 w-1/2 bg-gray-100 rounded-lg mt-2" })), /*#__PURE__*/
...
function Step({ step, stepOrder, setStep }) {
  ...
  return /*#__PURE__*/(
    ...
    status === "complete" ? /*#__PURE__*/React.createElement(CheckIcon, null) : /*#__PURE__*/React.createElement("span", null, stepOrder)));
